...
more). However, existing network extraction methods that use co-occurrence
...
of the entity nodes involved in that verb phrase. There is, to our knowledge, 
no existing open-source tool that
